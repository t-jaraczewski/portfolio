...
+ Languages: 
  ...
  + HTML/CSS *(basics)* - examples of simple projects using HTML and CSS:
      [Project#1](https://codepen.io/t-jaraczewski/full/NWMLEQv), [Project#2](https://codepen.io/t-jaraczewski/full/poVxxqv), [3](https://codepen.io/t-jaraczewski/full/yLjRwmP)
...
Beta testing 12 Polish-language and English-language Android apps downloaded from _Google Play Store_ (e.g. applications for recording your mood in everyday life, tracking activities for self-improvement, storm tracking, doing tests and tasks for final exams, checking the weather forecast, tracking your expenses, etc.):
  ...
  + sending issue reports (suggestions) to developers: [App#1](https://drive.google.com/file/d/1zzCccqvDV6Zj102AATYu1hmitOjVCaag/view?usp=sharing), [App#2](https://drive.google.com/file/d/1NPrKGPStWgIdBCt4CsL8wqK5haEggrYk/view?usp=sharing), [App#3]( 
