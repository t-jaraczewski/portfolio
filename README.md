...
+ Tools:
  ...
  + other: [Zephyr Squad](https://marketplace.atlassian.com/apps/1014681/zephyr-squad-test-management-for-jira?tab=overview&hosting=cloud), [Xray](https://www.getxray.app/), [Katalon Recorder]
+ Agile (Kanban, Scrum)
+ Testing Skills:
...
Beta testing 12 Polish-language and English-language Android apps downloaded from _Google Play Store_ (e.g. applications for recording your mood in everyday life, tracking activities for self-improvement, storm tracking, doing tests and tasks for final exams, checking the weather forecast, tracking your expenses, etc.):
  ...
  + sending issue reports (suggestions) to developers: [App#1](https://drive.google.com/file/d/1zzCccqvDV6Zj102AATYu1hmitOjVCaag/view?usp=sharing), [App#2]
